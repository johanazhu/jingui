...
var _useRefState3 = _interopRequireDefault(require("./useRefState"));
...
var useSetState = function useSetState() {
  ...
  var _useRefState = (0, _useRefState3.default)(initialState),
  ...
  var setMergeState = (0, _react.useCallback)(function (patch) {
    ...
    setState(function (prevState) {
      return _objectSpread(_objectSpread({}, prevState), (0, _utils.isFunction)(patch) ? patch(prevState) : patch);
    });
  }, []);
