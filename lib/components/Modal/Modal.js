...
var Modal = function Modal(props) {
  ...
  var classes = (0, _classnames4.default)(prefixCls, className);
  var renderTitle = function renderTitle() {
    if (title) {
      return /*#__PURE__*/_react.default.createElement("div", {
        className: (0, _classnames4.default)("".concat(prefixCls, "__header"), 'jing-hairline--bottom', _defineProperty({}, "".concat(prefixCls, "__header-isolated"), !message && !children))
      }, ' ', title);
    }
    return null;
  };
  var renderContent = function renderContent() {
    if (children) {
      return /*#__PURE__*/_react.default.createElement("div", {
        className: (0, _classnames4.default)("".concat(prefixCls, "__content"))
      }, children);
    }
    if (message) {
      var _classnames3;
      return /*#__PURE__*/_react.default.createElement("div", {
        className: (0, _classnames4.default)("".concat(prefixCls, "__content"), _defineProperty({}, "".concat(prefixCls, "__content-isolated"), !title))
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: (0, _classnames4.default)("".concat(prefixCls, "__message"), (_classnames3 = {}, _defineProperty(_classnames3, "".concat(prefixCls, "__message-has-title"), title), _defineProperty(_classnames3, "".concat(prefixCls, "__message-").concat(messageAlign), messageAlign), _classnames3))
      }, message));
    }
    return null;
  };
  var renderFooter = function renderFooter() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: (0, _classnames4.default)("".concat(prefixCls, "__footer"), _utils.BORDER_TOP)
      ...
      onClick: (_props$cancelProps3 = props.cancelProps) !== null && _props$cancelProps3 !== void 0 && _props$cancelProps3.loading ? _utils.noop : onCancel
    }), showConfirmButton && /*#__PURE__*/_react.default.createElement(_Button.default, {
      size: "large",
      text: confirmButtonText || '确认',
      className: (0, _classnames4.default)("".concat(prefixCls, "__confirm"), _utils.BORDER_LEFT),
      style: {
      ...
      onClick: (_props$confirmProps3 = props.confirmProps) !== null && _props$confirmProps3 !== void 0 && _props$confirmProps3.loading ? _utils.noop : onConfirm
    }));
  };
