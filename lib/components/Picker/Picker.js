...
var Picker = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var titleClass = (0, _classnames.default)("".concat(prefixCls, "__title"), 'jing-ellipsis');
  ...
  (0, _hooks.useEventListener)('touchmove', _utils.preventDefault, {
  ...
  var renderColumnItems = function renderColumnItems() {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, formattedColumns.map(function (item, columnIndex) {
  ...
  var renderColumns = function renderColumns() {
    ...
    var frameClass = (0, _classnames.default)("".concat(prefixCls, "__frame"), "jing-hairline-unset--top-bottom");
    return /*#__PURE__*/_react.default.createElement("div", {
      className: "".concat(prefixCls, "__columns"),
      ref: columnsRef,
      style: columnsStyle
    }, renderColumnItems(), /*#__PURE__*/_react.default.createElement("div", {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: classes
  }, showToolbar && renderToolbar(), loading && /*#__PURE__*/_react.default.createElement(_Loading.default, {
