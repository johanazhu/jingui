...
export default (props: IPreviewerProps) => {
    ...
    const [previewerProps, setPreviewerProps] =
        useState<null | IPreviewerProps>(null);
        ...
        if (
            ...
            setPreviewerProps(
                Object.assign({}, props, {
                    ...
                    hideActions: [
                        'EXTERNAL' as IPreviewerProps['hideActions'][0],
                    ].concat(props.hideActions),
                }),
            );
        } else {
    ...
    return (
        ...
        >
            {previewerProps && (
                <Previewer
                    className={
                        isActive ? '__dumi-default-previewer-target' : null
                    }
                    {...previewerProps}
                />
            )}
