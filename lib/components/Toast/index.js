...
var Toast = function Toast(p) {
  ...
  var bodyContainer = (0, _getContainer.resolveContainer)(mountContainer);
  ...
  var TempToast = function TempToast() {
    ...
    var _useState3 = (0, _react.useState)(_objectSpread({}, options)),
      _useState4 = _slicedToArray(_useState3, 2),
      state = _useState4[0],
      setState = _useState4[1];
    var internalOnClosed = (0, _react.useCallback)(function () {
    ...
    update.config = (0, _react.useCallback)(function (nextState) {
    ...
    return /*#__PURE__*/_react.default.createElement(_Toast.default, _extends({}, state, {
      visible: visible,
      mountContainer: function mountContainer() {
        return container;
      },
