...
var prefixCls = 'jing-timeline';
var Timeline = function Timeline(props) {
  var children = props.children,
    percent = props.percent,
    color = props.color;
  var count = _react.default.Children.count(children);
  var items = _react.default.Children.map(children, function (child, i) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "".concat(prefixCls, "--percent")
  }, percent === '100%' ? /*#__PURE__*/_react.default.createElement("em", {
    style: {
      width: percent
    }
