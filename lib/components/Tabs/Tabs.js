...
var Tabs = function Tabs(props) {
  ...
  var tabsNavRef = (0, _react.useRef)(null);
  var tabsTitleRef = (0, _react.useRef)([]);
  ...
  (0, _react.useEffect)(function () {
    ...
    duration && (0, _utils.scrollLeftTo)(navDom, to, duration);
    var lineStyle = {
  ...
  var classes = (0, _classnames2.default)(prefixCls, className, "".concat(prefixCls, "--").concat(type));
  ...
  var contentRender;
  if (swipeable) {
    contentRender = /*#__PURE__*/_react.default.createElement(_Swiper.Swiper, {
      ...
      return /*#__PURE__*/_react.default.createElement(_Swiper.SwiperSlide, {
        key: +index
      }, item.props.children);
    }));
  } else {
    contentRender = _react.default.Children.map(children, function (item, index) {
      return item.props.children && /*#__PURE__*/_react.default.createElement(_TabPanel.default, _extends({}, item.props, {
        key: +index,
        selected: Number(currentIndex) === index
      }));
    });
  }
  var Nav = _react.default.Children.map(children, function (item, index) {
    var _item$props = item.props,
      title = _item$props.title,
      img = _item$props.img;
    return /*#__PURE__*/_react.default.createElement(_TabsTitle.default, {
      ref: function ref(el) {
  ...
  var Wrap = /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames2.default)("".concat(prefixCls, "__wrap"), "".concat(prefixCls, "__wrap--").concat(type), _defineProperty({}, "".concat(prefixCls, "__wrap--scrollable"), !!scrollable))
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames2.default)("".concat(prefixCls, "__nav")),
    ref: tabsNavRef
  }, Nav, /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames2.default)("".concat(prefixCls, "__line")),
    style: lineStyle
  })));
  return /*#__PURE__*/_react.default.createElement("div", {
    className: classes,
    style: style
  }, sticky ? /*#__PURE__*/_react.default.createElement(_Sticky.default, null, " ", Wrap, " ") : Wrap, /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames2.default)("".concat(prefixCls, "__content"))
  }, contentRender));
};
