...
var Keyboard = function Keyboard(props) {
  ...
  var className = props.className,
    ...
    layout = _props$layout === void 0 ? _utils2.letterLayout : _props$layout,
  ...
  var keyboardKeysRef = (0, _react.useRef)(null);
  // const keyRef = useRef<any>([]);
  var valueRef = (0, _react.useRef)(value);
  var showRef = (0, _react.useRef)(visible);
  var _useRefs = (0, _hooks.useRefs)(),
    _useRefs2 = _slicedToArray(_useRefs, 3),
    refs = _useRefs2[0],
    setRefs = _useRefs2[1],
    resetRefs = _useRefs2[2];
  var _useState = (0, _react.useState)(layoutName),
  ...
  var _useState5 = (0, _react.useState)(220),
  ...
  var classes = (0, _classnames2.default)(prefixCls, className, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "__layout-").concat(layoutNamePlus), theme.indexOf('letter') >= 0), _defineProperty(_classnames, "".concat(prefixCls, "__layout-").concat(theme), theme.indexOf('letter') !== 0), _classnames));
  ...
  (0, _react.useEffect)(function () {
    ...
    keyboardRef === null || keyboardRef === void 0 ? void 0 : (_keyboardRef$current = keyboardRef.current) === null || _keyboardRef$current === void 0 ? void 0 : _keyboardRef$current.addEventListener('touchstart', _utils.stopPropagation, {
      passive: false
    });
    return function () {
      var _keyboardRef$current2;
      keyboardRef === null || keyboardRef === void 0 ? void 0 : (_keyboardRef$current2 = keyboardRef.current) === null || _keyboardRef$current2 === void 0 ? void 0 : _keyboardRef$current2.removeEventListener('touchstart', _utils.stopPropagation);
    };
  }, [visible]);
  ...
  var getButtonDisplayName = function getButtonDisplayName(button, display) {
    display = display || (0, _utils2.getDefaultDisplay)();
  ...
  var handleTouchMove = function handleTouchMove(event) {
    ...
    refs.forEach(function (element) {
      var eleRect = (0, _useRect.getRect)(element);
      if (currentPageX > (eleRect === null || eleRect === void 0 ? void 0 : eleRect.left) && currentPageX < (eleRect === null || eleRect === void 0 ? void 0 : eleRect.right) && currentPageY > (eleRect === null || eleRect === void 0 ? void 0 : eleRect.top) && currentPageY < (eleRect === null || eleRect === void 0 ? void 0 : eleRect.bottom)) {
        ...
        } else if ((0, _utils2.getCantActive)(element.innerText)) {
          setActiveElement('');
        } else {
  ...
  var renderShiftButton = function renderShiftButton() {
    return layoutNamePlus === 'default' ? /*#__PURE__*/_react.default.createElement(_Icon.IconKeyboardShiftLine, {
      className: "".concat(prefixCls, "-key__shift-icon"),
      onClick: function onClick(e) {
        (0, _utils.stopPropagation)(e);
      }
    }) : /*#__PURE__*/_react.default.createElement(_Icon.IconKeyboardShift, {
      className: "".concat(prefixCls, "-key__shift-icon"),
      onClick: function onClick(e) {
        (0, _utils.stopPropagation)(e);
      }
  ...
  var renderOthers = function renderOthers() {
    ...
    if (theme === 'custom-number') {
      ...
      _layout = (0, _utils2.themeToLayout)(theme);
    }
    ...
    return (_layout2 = _layout) === null || _layout2 === void 0 ? void 0 : _layout2.map(function (row, rIndex) {
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, rowArray.map(function (item, index) {
        ...
        if (buttonDisplayName === 'emty') {
          return /*#__PURE__*/_react.default.createElement(_Key.default, {
  ...
  var renderLetter = function renderLetter() {
    ...
    if (theme === 'custom-letter') {
      ...
      if (!(0, _utils.isObject)(props.layout)) {
  ...
  var renderTitle = function renderTitle() {
    ...
    }, title === '安全键盘' && /*#__PURE__*/_react.default.createElement(_Icon.IconKeyboardSecurity, null), title), /*#__PURE__*/_react.default.createElement("div", {
      className: "".concat(prefixCls, "__header-right"),
      onClick: onClose,
      style: {
        width: keyboardHeaderHeight
      }
    }, /*#__PURE__*/_react.default.createElement(_Icon.IconArrow, null)));
  };
...
var _default = /*#__PURE__*/(0, _react.memo)(Keyboard);
